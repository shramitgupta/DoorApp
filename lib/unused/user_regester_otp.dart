...
class UserRegisterOtp extends StatefulWidget {
  ...
  @override
  State<UserRegisterOtp> createState() => _UserRegisterOtpState();
}

class _UserRegisterOtpState extends State<UserRegisterOtp> {
